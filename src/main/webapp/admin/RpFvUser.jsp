...
<body <c:if test="${empty listreport2 }">onload="launch_toast()"</c:if> >
<c:url var="url" value="/AdminServlet"></c:url>
	<div class="container">
		<form action="${url }" method="get">
			...
			<button class="btn btn-outline-secondary" formaction="${url }/findfavouser"
		...
		<div class="container table-responsive py-5">
			<table class="table table-bordered table-hover">
				...
				<tbody>
					<c:forEach var="item" items="${listreport2 }">
						<tr>
